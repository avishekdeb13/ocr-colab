...
input_path = "E:/ATALOUD/HDFC-NEW/Aadhaar images/1.jpg"  # Path to the Input Image/PDF

if input_path.split('.')[-1] == "pdf":
    pages = convert_from_path(input_path, 300,poppler_path=r'F:\SOFTWARES\Installed files\poppler-0.68.0\bin')
